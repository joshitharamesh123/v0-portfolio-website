...
function SocialIcon({ icon }: { icon: string }) {
  switch (icon) {
    ...
    case "twitter":
      return (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          <path d="M23.953 4.57a10 10 0 002.856-3.51 10.019 10.019 0 01-2.836.771 4.96 4.96 0 002.164-2.723c-.951.555-2.005.959-3.127 1.184a4.93 4.93 0 00-8.506 4.482c-4.08-.204-7.7-2.164-10.149-5.144a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63a9.935 9.935 0 002.457-2.548l-.047-.02z" />
        </svg>
      )
    default:
      return null
